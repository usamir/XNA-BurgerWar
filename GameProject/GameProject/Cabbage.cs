...
namespace GameProject
{
    ...
    public class Cabbage
    {
        ...
        public Cabbage(ContentManager contentManager, string spriteName, int x, int y,
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotTime > firingDelay)
            {
                ...
                Projectile projectile = new Projectile(ProjectileType.Cabbage,
                        Game1.GetProjectileSprite(ProjectileType.Cabbage),
                        drawRectangle.Center.X,
                        drawRectangle.Center.Y + GameConstants.RED_CABBAGE_PROJECTILE_OFFSET,
        ...
        {
            return GameConstants.CABBAGE_MIN_FIRING_DELAY +
                RandomNumberGenerator.Next(GameConstants.CABBAGE_FIRING_RATE_RANGE);
        }
        ...
        private float GetProjectileYVelocity()
        {
            if (velocity.Y > 0)
            {
                return velocity.Y + GameConstants.RED_CABBAGE_PROJECTILE_SPEED;
            }
            else
            {
                return GameConstants.RED_CABBAGE_PROJECTILE_SPEED;
            }
        }
